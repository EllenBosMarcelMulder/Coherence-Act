# 📐 Total System Overview in Formula Form (English)
...
$$
ASR = \frac{Internal Sanctions}{Violations} > 0.8
$$

**P8. Legal Consequence Probability**

$$
LCP = \frac{Prosecutions}{Cases} < 0.1
$$
...
\begin{cases}
1 & \text{fully allowed} \\
\theta & \text{partially allowed (0<θ<1)} \\
0 & \text{blocked}
\end{cases}
$$
...
* Letter → number → frequency → spectrum
...
$$
ClosedCycle = \{P0 \to P1 \to \cdots \to P8 \to P_\infty \to P0 \to Loop\}
$$
